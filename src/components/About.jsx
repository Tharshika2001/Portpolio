        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I am a passionate <span className="text-[#F3DBB3] font-medium">Software Engineering undergraduate</span> specializing in creating engaging, production-style web applications. With a strong foundation in computer science and a keen interest in modern architectures, I engineer complete systems across frontend, backend, and relational database layers that deliver real-world impact.
            </motion.p>

            {/* Achievement Metrics Grid */}
            <motion.div 
              variants={fadeUpVariants}
              className="grid grid-cols-3 gap-4 sm:gap-6 pt-6 pb-2 border-t border-[#8C6D4F]/25 max-w-lg"
            >
              {/* Stat 1 */}
              <div className="p-4 rounded-xl border border-[#8C6D4F]/30 bg-[#0E0C0A] flex flex-col items-center sm:items-start group hover:border-[#D4AF37]/70 transition-colors">
                <span 
                  className="text-3xl sm:text-4xl font-light text-[#F4EBE2] tracking-tight group-hover:text-[#D4AF37] transition-colors"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  +6
                </span>
                <span className="text-[9.5px] sm:text-[10px] font-medium tracking-[0.2em] uppercase text-[#A8988B] mt-1 text-center sm:text-left">
                  Projects Completed
                </span>
              </div>
          ...
          {/* Right Portrait Frame (3D Physics) */}
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                <img
                  src={profileImg}
                  alt="Tharshika"
                  className="w-full h-full object-cover object-center filter brightness-[0.95] contrast-[1.05] group-hover:brightness-105 group-hover:scale-105 transition-all duration-700 ease-out"
                />
